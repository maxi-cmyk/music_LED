...
For example, if $E[k] = 3$ and $W_N^k O[k] = i$, the paired outputs are $3+i$ and $3-i$. The implementation repeats this combine pattern across $\log_2 N$ stages instead of recomputing every matrix term independently.
